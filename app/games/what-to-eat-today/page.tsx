...
import { Utensils, RotateCcw, Share2, MapPin, DollarSign, Clock, Zap, Heart, Star, Users } from 'lucide-react'
    ...
    >
      ...
      {!currentFood ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-4">开始选择</h3>
          <p className="text-gray-600 mb-6">点击按钮，让命运决定你今天的美食！</p>
          <button
            onClick={pickRandomFood}
            className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-xl font-bold text-lg hover:from-orange-600 hover:to-red-600 transition-all transform hover:scale-105"
          >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-semibold text-gray-900">{currentFood.name}</h3>
            <button
          ...
          <p className="text-gray-600 mb-4">{currentFood.description}</p>
